...
document.getElementById('save').addEventListener('click', addApplication);
...
/**
  ...
  @param {event} event
*/
const showApplicationForm = (event) => {
...
document.getElementById('showForm').addEventListener('click', showApplicationForm);
